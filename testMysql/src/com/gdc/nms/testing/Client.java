...
public class Client implements Executable {
    ...
    public Client() throws IllegalLocalAddress {
    	System.out.println("local adress"+getLocalAddress());
    ...
    private void readServers() throws Exception {
        ...
        if (lines.size() <= 0) {
            ...
            for (String line : lines) {
                ...
                System.out.println("servers"+servers.get(0).getSshCredential().getHostname());
            }
        }
    }
                    ...
                    try {
                        ...
                        try {
                            ...
                            shell.uploadFile(new File(System.getProperty("user.dir") + "/" + "tester.jar"),
                                server.getGlassfishPath(), "", new SftpProgressMonitor() {
									...
									@Override
									public void end() {
										System.out.println("Tester.jar OK");
									}
    ...
    public static void main(String[] args) {
    	System.out.println(""+System.getProperty("user.dir") + "/servers.lst");
	}
